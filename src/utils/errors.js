...
export const categorizeError = (error) => {
  ...
  // Next.js和前端框架的可忽略错误
  if (
    errorMessage.includes('Invariant: attempted to hard navigate') ||
  ...
  // HTTP错误码
  if (
    errorMessage.includes('HTTP 5') || // 5xx服务器错误可重试
  ...
  if (
    errorMessage.includes('HTTP 4') || // 4xx客户端错误通常不可重试
